...
from fairseq.data.audio.speech_text_triple_align_nllb_dataset import (
    flores_codes,
    SpeechTextTripleAlignNLLBDataset, 
    SpeechTextTripleAlignNLLBDatasetCreator
)
...
@register_task("speech_to_text_triplet_align_with_extra_mt_nllb")
class SpeechToTextTripletAlignWithExtraMTNLLBTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        st_dataset = SpeechTextTripleAlignNLLBDatasetCreator.from_tsv(
            self.args.data,
            self.data_cfg,
            split,
            self.src_dict,
    ...
    def get_batch_iterator(
        ...
        if not isinstance(dataset, MultiModalityDataset):
            return super(SpeechToTextTripletAlignWithExtraMTNLLBTask, self).get_batch_iterator(
                dataset,
                max_tokens,
                max_sentences,
                max_positions,
    ...
    def build_model(self, args):
        ...
        model = super(SpeechToTextTripletAlignWithExtraMTNLLBTask, self).build_model(args)

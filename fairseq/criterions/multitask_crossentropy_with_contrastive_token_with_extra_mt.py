...
@register_criterion("multi_task_cross_entropy_with_contrastive_token_with_extra_MT")
class MultiTaskCrossEntropyWithContrastiveTokenWithExtraMT(LabelSmoothedCrossEntropyWithContrastiveTokenCriterion):
    def __init__(
        self,
        task,
        sentence_avg,

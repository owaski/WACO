...
mkdir -p ${MODEL_DIR}
cp $SAVE_DIR/$tag/$pretrain_ckpt $SAVE_DIR/$tag/checkpoint_last.pt
...
fairseq-train $DATA_ROOT \
    ...
    --contrastive-weight 0.0 0.0 --contrastive-temperature 0.05 0.05 --contrastive-seqlen-type none --contrastive-level token \
    \
